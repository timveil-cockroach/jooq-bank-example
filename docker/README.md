...
```bash
docker cp roach-cert:/.cockroach-certs/client.maxroach.crt .
docker cp roach-cert:/.cockroach-certs/client.maxroach.key .
docker cp roach-cert:/.cockroach-certs/client.maxroach.key.pk8 .
```
